...
exports.create = (req, res) => {
  ...
  const resolt = {
    ...
    outputAnswer: req.body.outputAnswer,
    codiId: req.body.codiId,
...
exports.findAll = (req, res) => {
    ...
    Resolt.findAll({ where: condition })
      .then(data => {
        res.send(data);
      })
      .catch(err => {
...
exports.deleteByExercici = (req, res) => {
  const id = req.params.id;
  Resolt.destroy({
      where: { codiId: id }
    })
